...
def training(model, train_loader, test_loader, learning_rate, epochs, batch_size, lambda_reg, data_name, file_mode = "chg"):
    ...
    torch.save(model.state_dict(),
               './Saved_Models/vae_{}_{}.pt'.format(data_name, file_mode))
...
#         "H1": 26,
    ...
    for data_name in names:
        ...
        fname = f'./Recourse_Methods/Generative_Model/Saved_Models/vae_{data_name}_rr_cfe.pt'
        ...
        model = model_vae.VAE_model(input_size,
                                   ...
                                   data_meta_info['H1'],
                                   data_meta_info['H2'])
#         model = model_vae.VAE_model_theory(input_size,
#                                    data_meta_info['activFun'],
#                                    data_meta_info['d'],
#                                    data_meta_info['H1'],
#                                    data_meta_info['H2'])
